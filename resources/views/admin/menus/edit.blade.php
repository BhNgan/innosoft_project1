...
@section('content')
<form method="POST" action="{{ route("$route.update", ['menu' => $data]) }}" role="form">
@method('PUT')
@csrf
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="menu_name" id="menu_name" required placeholder="{{ __("admin/$route.menu_name") }}" maxlength="191" value="{{ old('menu_name', $data->menu_name) }}">
                </div>
                <div class="form-group">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group type-group homeGroup">
                    ...
                    <select class="form-control" id="banner" name="banner_id">
                        @foreach ($categories as $category)
                        <option value="{{ $category->id }}">{{ $category->category_name }}</option>
                        @endforeach
                    </select>
...
@push('ready')
    ...
    $("#banner").val("{{ old('banner_id', $banner->id ?? '') }}");
@endpush