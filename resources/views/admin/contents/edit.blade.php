...
@section('content')
<form method="POST" action="{{ route("$route.update", ['content' => $data]) }}" role="form" enctype="multipart/form-data">
@method('PUT')
@csrf
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" id="title" required placeholder="{{ __("admin/$route.title") }}" maxlength="191" value="{{ old('title', $data->title) }}">
                </div>
                <div class="form-group">
                    <label for="alias">{{ __("admin/$route.alias") }} (*)</label>
                    <input type="text" class="form-control" name="alias" id="alias" required placeholder="{{ __("admin/$route.alias") }}" maxlength="191" value="{{ old('alias', $data->alias) }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="views" id="views" required placeholder="{{ __("admin/$route.views") }}" maxlength="191" value="{{ old('views', $data->views) }}">
                </div>
                <div class="form-group">
                    <label for="description">{{ __("admin/$route.description") }}</label>
                    <input type="text" class="form-control" name="description" id="description" placeholder="{{ __("admin/$route.description") }}" maxlength="191" value="{{ old('description', $data->description) }}">
                </div>
                <div class="form-group">
                ...
                <input hidden type="text" name="is_draft" id="is_draft" value="{{ old('is_draft', $data->is_draft) }}">
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="upload">{{ old('upload', $data->avatar ?? __("admin/$route.avatar")) }}</label>
                    </div>
                </div>
                <div class="form-group">
                    <label for="video">{{ __("admin/contents.video") }}</label>
                    <input type="text" class="form-control" name="video" id="video" placeholder="{{ __("admin/contents.video") }}" value="{{ old('video', $data->video ?? "") }}" maxlength="191">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="summary" name="summary" rows="3">{{ old('summary', $data->summary) }}</textarea>
                </div>
                <div class="form-group">
                    <label for="content">{{ __("admin/$route.content") }}</label>
                    <textarea id="content" name="content" rows="3">{{ old('content', $data->content) }}</textarea>
                </div>
            </div>
        </div>
    </div>
...
@push('ready')
    ...
    $("#video").keyup();
    $("#categories").val({{ $content_categories }});
@endpush
