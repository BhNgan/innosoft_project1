...
@section('content')
<form method="POST" action="{{ route("$route.update", ['sponsor' => $data]) }}" role="form" enctype="multipart/form-data">
@method('PUT')
@csrf
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="sponsor_name" id="sponsor_name" placeholder="{{ __("admin/$route.sponsor_name") }}" maxlength="191" value="{{ old('sponsor_name', $data->sponsor_name) }}" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" maxlength="191" id="note" name="note" rows="3">{{ old('note') }}</textarea>
                    </div>
                </div>
            </div>
    </div>
