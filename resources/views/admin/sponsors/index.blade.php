    ...
    <table id="table-data" class="table table-hover">
        <thead>
            <tr>
                ...
                <th scope="col">{{ __("admin/$route.sponsor_name") }}</th>
        ...
        <tbody id="data">
            ...
            <tr>
                ...
                @if (Route::has("$route.edit"))
                <td class="px-1">
                    <a href="{{ route($route . '.edit', ['sponsor' => $data]) }}" class="btn btn-primary" title="{{ __('admin/table.update') }}">
                ...
                @if (Route::has("$route.destroy"))
                <td class="px-1">
                    <div data-toggle="modal" data-target="#cfmDel" onclick="$('#formDelete').attr('action', '{{ route("$route.destroy", ['sponsor' => $data]) }}');" class="btn btn-danger" title="{{ __('admin/table.delete') }}">
